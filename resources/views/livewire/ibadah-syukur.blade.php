    ...
    @else
        <div class="mb-5">
            <form>
                ...
                <button type="submit" wire:click.prevent="kirim"
                    class="btn btn-primary btn-block mb-4 rounded-9">Kirim</button>
            </form>
            <a href="" wire:click.prevent="register" class="text-decoration-underline">Lihat jadwal ibadah
                syukur</a>
        </div>
    @endif
</div>
