...
<body>
    <div class="container-xxl bg-white p-0">
        ...
        <div class="container-xxl py-5">
            <marquee direction=”left” scrollamount=”2″ align=”center”><b>-- Silahkan cek jadwal yang tersedia sebelum
                    melakukan pendaftaran! --</b></marquee>
            <div class="container">
        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-3 col-md-6">
                    ...
                    <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>Jl. Jend A.Yani 079-081, Kuala Kapuas,
                        Kalimantan Tengah</p>
