    ...
    <div class="container">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('pengumuman.update', $data->id) }}">
                    @csrf
                    @method('PATCH')
                    ...
                    <div class="form-group my-3">
                        ...
                        <textarea class="ckeditor  form-control" id="exampleFormControlTextarea1" rows="3" name="isi">{{ $data->isi }}</textarea>
                    </div>

                    <div class="d-flex justify-content-end pe-0 me-0">
                        <a href="{{ route('pengumuman.index') }}" class="btn btn-secondary btn-sm w-auto px-3 me-2"
            ...
            <div class="modal-dialog ">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <form method="POST" action="{{ route('pengumuman.destroy', $data->id) }}">
                            @csrf
                            @method('DELETE')
