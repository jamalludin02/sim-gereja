                ...
                <div class="container my-5 py-5">
                    <div class="row align-items-center g-5">
                        <div class="col-lg-6 text-center text-lg-start">
                            ...
                            <p class="text-white animated slideInLeft mb-4 pb-2">Website Gereja Evangelis Kalimantan
                                Sinta
                                Kuala Kapuas</p>
                            <p class="text-white animated slideInLeft mb-4 pb-2">Silahkan Cek Nama Anda Terlebih Dahulu
                            </p>
                            <div class="input-group">
                                <input type="search" id="namesearch" class="form-control rounded"
                                    placeholder="Cek Nama Lengkap Anda" aria-label="Search"
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-6">
                        <div id="formIbadah">
                            <h5 class="section-title ff-secondary text-start text-primary fw-normal">Jadwal Ibadah
                                Syukur
                            </h5>
                            <div>
                            ...
                            <div>
                                <label class="form-label" id="waktu" for="form7Example2"></label>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-6">
                        ...
                        <p class="mb-4">Gereja Kalimantan Evangelis (disingkat GKE) atau Gereja Evangelikal di
                            Kalimantan
                            (Bahasa Inggris) (Kalimantan Evangelical Church) ialah sebuah kelompok gereja Kristen
                            Protestan
                            di Indonesia yang didirikan pada tanggal 10 April 1839, awalnya dengan nama Gereja Dayak
                            Evangelis (GDE). Gereja ini melakukan pelayanan iman kepada suku-suku di pulau Kalimantan
                            yaitu
                            suku-suku yang termasuk ke dalam rumpun suku Dayak, meski begitu GKE tidak tertutup bagi
                            anggota
                ...
                <div class="container py-5">
                    <div class="row g-5">
                        <div class="col-lg-3 col-md-6">
                            ...
                            <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>Jl. S.Parman No.88, Selat
                                Hilir,
            ...
            var calendar = new FullCalendar.Calendar(calendarEl, {
                eventClick: function(eventObj) {
                    if (eventObj.url) {
                        ...
                        $('#tanggal').show();
                        $('#waktu').show();
                        $('#nama').text('Judul Acara: ' + eventObj.event.title);
                        $('#tanggal').text('Tanggal: ' + eventObj.event.start.toLocaleDateString(
                            'id-ID', {
                                weekday: 'long',
                                year: 'numeric',
                                month: 'long',
                        ...
                        var newTime = eventObj.event.extendedProps.time;
                        ...
                        $('#waktu').text('Waktu: ' + formattedTime + ' WIB - Selesai');
                    }
                },
