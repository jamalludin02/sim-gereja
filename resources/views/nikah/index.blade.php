...
<body>
    <div class="container-xxl bg-white p-0">
        ...
        <marquee direction=”left” scrollamount=”2″ align=”center”><b>-- Silahkan klik daftar untuk melakukan pendaftaran pemberkatan nikah! --</b></marquee>
            <div class="container">
                <h1>Pendaftaran Pemberkatan Nikah</h1>
                    <div class="container mt-4">
                    <a href="/form-ibadah-syukur" class="btn btn-danger rounded-9 text-capitalize">
                        Daftar</a>
                <div class="row">
               <br>
